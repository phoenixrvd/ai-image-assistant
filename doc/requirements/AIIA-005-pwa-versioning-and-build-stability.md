...
- The selected application language remains available after reload, PWA restart, and application updates.
...
- Existing local data is not translated or overwritten when the application language changes.
