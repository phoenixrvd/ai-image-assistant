...
- Language selection is documented as part of the global options area, not as a chat-scoped setting.
- Relative dates and times use the active application language.
